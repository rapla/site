---
title: Documentation
description: Guides for users, administrators and developers — maintained in the wiki
---
...
- {{< wiki "DatabaseInstallation" "Database" >}}
- {{< wiki "creating-a-linux-service-with-systemd" "Linux service (systemd)" >}}
...
- {{< wiki "PeriodSupport" "Periods" >}}
- {{< wiki "Permissions" "Permissions and groups" >}}
...
- {{< wiki "RunWithDocker" "Run with Docker" >}}
- {{< wiki "PluginDevelopment" "Plugin development" >}}
- {{< wiki "InteractingWithTheServer" "Interacting with the server" >}}
{{< /card >}}
{{< /cards >}}

Something missing? Check the {{< wiki "FAQ" "FAQ" >}}.
